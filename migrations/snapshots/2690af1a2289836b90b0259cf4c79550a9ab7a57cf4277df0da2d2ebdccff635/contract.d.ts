...
export type StorageHash =
  StorageHashBase<'2690af1a2289836b90b0259cf4c79550a9ab7a57cf4277df0da2d2ebdccff635'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly User: {
      ...
      readonly role: 'CUSTOMER' | 'FARMER' | 'ADMIN';
        ...
        readonly entries: {
          ...
          readonly valueSet: {
            readonly UserRole: {
              ...
              readonly values: readonly ['CUSTOMER', 'FARMER', 'ADMIN'];
            };
          };
        };
      };
